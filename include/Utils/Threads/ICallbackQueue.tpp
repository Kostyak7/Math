...
template<typename F>
auto util::mthrd::make_safe_callback(F callback, std::weak_ptr<const void> lifetime) {
...
template<typename F>
auto util::mthrd::make_safe_callback(F callback, std::weak_ptr<const void> lifetime, std::weak_ptr<ICallbackQueue> callback_queue) {
...
template <typename F>
void util::mthrd::call_in_worker(F callback, std::weak_ptr<ICallbackQueue> callback_queue, std::optional<std::weak_ptr<const void>> lifetime) {
...
std::future<R> util::mthrd::SyncCaller<BaseClass>::sync(R(DerivedClass::* method)(MArgs...), Args&&... args) {
...
template <typename BaseClass>
template <typename F>
std::future<std::invoke_result_t<F>> util::mthrd::SyncCaller<BaseClass>::add_sync(F&& callback, std::optional<std::weak_ptr<const void>> lifetime) {
...
template <typename BaseClass>
template<typename DerivedClass, typename R, typename... MArgs, typename... Args>
std::future<R> util::mthrd::AsyncCaller<BaseClass>::async(R(DerivedClass::* method)(MArgs...), Args&&... args) {
    static_assert(std::is_base_of_v<BaseClass, DerivedClass>, "Mismatch deriving");
...
template <typename BaseClass>
template <typename F>
std::future<std::invoke_result_t<F>> util::mthrd::AsyncCaller<BaseClass>::add_async(F&& callback, std::optional<std::weak_ptr<const void>> lifetime) {
    static_assert(std::is_base_of_v<ICallbackQueue, BaseClass>, "Caller does not belong to ICallbackQueue");
...
template <typename BaseClass>
template<typename DerivedClass, typename R, typename... MArgs, typename... Args>
std::future<R> util::mthrd::TypedCaller<BaseClass>::typed_call(ExecutionType type, R(DerivedClass::* method)(MArgs...), Args&&... args) {
...
template <typename BaseClass>
template <typename F>
std::future<std::invoke_result_t<F>> util::mthrd::TypedCaller<BaseClass>::add_command(ExecutionType type, F&& callback, std::optional<std::weak_ptr<const void>> lifetime) {
    if (type == ExecutionType::SYNCHRONE) {
