...
namespace math::geom {
    ...
    double orientation_2d(const Point2D& a, const Point2D& b, const Point2D& c); // > 0 ����� �������, < 0 ������ �������, = 0 �� ����� ������
    double orientation_3d(const Point3D& a, const Point3D& b, const Point3D& c, const Point3D& d); // > 0 �� ���� �� ������ ��������� ABC, ..., = 0 ��� � ����� ���������
